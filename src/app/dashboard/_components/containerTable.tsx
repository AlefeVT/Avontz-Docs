...
//   const [containerData, setContainerData] = React.useState<ContainerData | null>(null);
...
//   const { isDeleting, handleDeleteContainer } = useContainerActions(refreshData);
...
//         description={`Tem certeza de que deseja excluir ${selectedContainersForDelete.length === 1
